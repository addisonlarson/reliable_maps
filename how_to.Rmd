...
**tl;dr** Download Census data. Get rid of extra columns, blank cells, and special characters. Export as a \texttt{.csv}. [\texttt{\underline{Use the calculator}}](https://aplarson.shinyapps.io/MapClassificationAutoreporter/).
...
require(tidycensus); require(tidyverse)
